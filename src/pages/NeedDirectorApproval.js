...
import { ConfirmDirectorApproval } from "../components/confimation";

export default function NeedDirectorApproval({ match, history }) {
  ...
  return (
    <AppContainer>
      ...
      >
        {status?.director?.isApproved ? "Re Approve" : "Approve"}
      </Button>
