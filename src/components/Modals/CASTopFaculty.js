...
export default function CASTopFaculty({ responses }) {
  const top5 = [...responses]
    .sort((a, b) => b?.ratings?.average - a?.ratings?.average)
    .slice(0, 5);

  const data = {
    labels: [
      `${top5[0]?.status?.faculty?.user?.name?.firstName} ${top5[0]?.status?.faculty?.user?.name?.lastName} (${top5[0]?.status?.faculty?.user?.dept})`,
      `${top5[1]?.status?.faculty?.user?.name?.firstName} ${top5[1]?.status?.faculty?.user?.name?.lastName} (${top5[1]?.status?.faculty?.user?.dept})`,
      `${top5[2]?.status?.faculty?.user?.name?.firstName} ${top5[2]?.status?.faculty?.user?.name?.lastName} (${top5[2]?.status?.faculty?.user?.dept})`,
      `${top5[3]?.status?.faculty?.user?.name?.firstName} ${top5[3]?.status?.faculty?.user?.name?.lastName} (${top5[3]?.status?.faculty?.user?.dept})`,
      `${top5[4]?.status?.faculty?.user?.name?.firstName} ${top5[4]?.status?.faculty?.user?.name?.lastName} (${top5[4]?.status?.faculty?.user?.dept})`,
    ],
    datasets: [
      {
        data: [
  ...
  return (
    <Container>
      <h5 className="text-uppercase fw-bold mb-4">Top 5 CAS Faculty</h5>
